...
export default function PersonalCard({ width, height }: PersonalCardProps) {
    return (
        <svg
            width={width || 24}
            height={height || 24}
        ...
        >
            ...
            />
            <path d="M14 8H19" stroke="#888888" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M15 12H19" stroke="#888888" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M17 16H19" stroke="#888888" strokeLinecap="round" strokeLinejoin="round" />
            <path
