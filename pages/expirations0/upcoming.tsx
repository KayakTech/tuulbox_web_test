...
export default function UpcomingExpirations() {
    ...
    return (
        <DashboardLayout
            ...
            breadCrumbs={[{ name: "Expirations", url: "/expirations" }, { name: "Upcoming" }]}
        >
            <div className="mt-4">
                <ExpirationsMenu />
            </div>
            ...
            <EmptyState
                ...
                headerText="No Upcoming Expirations"
                descriptionText="Upcoming Expirations added can be managed here"
            />
        </DashboardLayout>
    );
}
